...
function showFormula() {
    ...
    switch (conversionType) {
        case 'flOzToMl':
            formula = "Formula: 1 fluid ounce = 29.5735 milliliters";
            break;
        case 'galToL':
            formula = "Formula: 1 gallon = 3.78541 liters";
            break;
        case 'cuFtToCuM':
            formula = "Formula: 1 cubic foot = 0.0283168 cubic meters";
            break;
        case 'cuYdToCuM':
            formula = "Formula: 1 cubic yard = 0.764555 cubic meters";
            break;
        default:
            formula = "";
    }
